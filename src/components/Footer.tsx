...
export function Footer() {
  return (
    <footer className="from-boliviana-pink via-boliviana-purple to-boliviana-purple text-boliviana-cream mt-auto bg-gradient-to-b from-0% via-[16%] to-100% px-6 py-8 sm:px-10">
